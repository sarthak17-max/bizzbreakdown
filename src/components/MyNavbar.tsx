  ...
  return (
    <>
      <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white sticky top-0 z-50">
        <button onClick={() => setOpen(true)} className="text-gray-600 text-xl">☰</button>
        ...
        <Link href="/search" className="text-gray-600 text-xl">🔍</Link>
      </nav>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white shadow-xl z-[70] transform transition-transform duration-300 ${
